...
public class AppPreferenceManager {
    ...
    public static final String KEY_IS_FIRST_SHAKE_LOGGED = "com.ajman.ded.ae.shake_logged";
    public static final String KEY_IS_FIRST_SHAKE_GUEST = "com.ajman.ded.ae.shake_guest";
